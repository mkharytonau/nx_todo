...
tasks_actions = [
    ...
    url(r'^addowner/$', views.add_owner, name='addowner'),
    url(r'^removeowner/(?P<o_id>\w+)$', views.remove_owner, name='removeowner'),
    url(r'^addreminder/$', views.add_reminder, name='addreminder'),
    url(r'^removereminder/(?P<r_id>\d+)$', views.remove_reminder, name='removereminder'),
]
...
tasks_urlpatterns = [
    ...
    url(r'^filter/$', views.filter_tasks, name='tasks_filter')
]
