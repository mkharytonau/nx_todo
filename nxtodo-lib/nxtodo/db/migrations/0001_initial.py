# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-06-16 23:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('created_by', models.CharField(max_length=30, null=True)),
                ('events', models.ManyToManyField(to='db.Event')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_check_time', models.DateTimeField(default=datetime.datetime(1, 1, 1, 0, 0))),
                ('after_term_check', models.BooleanField(default=False)),
                ('plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.Plan')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_check_time', models.DateTimeField(default=datetime.datetime(1, 1, 1, 0, 0))),
                ('after_term_check', models.BooleanField(default=False)),
                ('reminder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.Reminder')),
        ...
        migrations.AddField(
            model_name='user',
            name='events',
            field=models.ManyToManyField(through='db.UserEvents', to='db.Event'),
        ),
        migrations.AddField(
            model_name='user',
            name='plans',
            field=models.ManyToManyField(through='db.UserPlans', to='db.Plan'),
        ),
        migrations.AddField(
            model_name='user',
            name='tasks',
            field=models.ManyToManyField(through='db.UserTasks', to='db.Task'),
        ),
        migrations.AddField(
            model_name='task',
            name='reminders',
            field=models.ManyToManyField(through='db.TaskReminders', to='db.Reminder'),
        ),
        migrations.AddField(
            model_name='task',
            name='subtasks',
            field=models.ManyToManyField(to='db.Task'),
        ),
        migrations.AddField(
            model_name='reminder',
            name='user',
        ...
        migrations.AddField(
            ...
            name='reminder',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.Reminder'),
        ),
        migrations.AddField(
            model_name='plan',
            name='reminders',
            field=models.ManyToManyField(through='db.PlanReminders', to='db.Reminder'),
        ),
        migrations.AddField(
            model_name='plan',
            name='tasks',
        ...
        migrations.AddField(
            model_name='event',
            name='reminders',
            field=models.ManyToManyField(through='db.EventReminders', to='db.Reminder'),
        ),
    ]
