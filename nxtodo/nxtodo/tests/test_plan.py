...
class TestPlan(unittest.TestCase):
    ...
    def test_add_reminders_to_plan(self):
        ...
        self.assertTrue(
            plan.reminder_set.filter(description='test_reminder_3'))
    ...
    def test_check_plans(self):
        ...
        self.assertEqual(
            len(queries.get_reminders(USER_NAME,
                                      description='test_reminder_1')), 2)
        self.assertEqual(
            len(queries.get_reminders(USER_NAME,
                                      description='test_reminder_2')), 2)
        ...
        self.assertEqual(
            len(queries.get_reminders(USER_NAME,
                                      description='test_reminder_1')), 3)
        self.assertEqual(
            len(queries.get_reminders(USER_NAME,
                                      description='test_reminder_2')), 3)
        ...
        self.assertEqual(
            len(queries.get_reminders(USER_NAME,
                                      description='test_reminder_1')), 4)
        self.assertEqual(
            len(queries.get_reminders(USER_NAME,
                                      description='test_reminder_2')), 4)
        ...
        self.assertEqual(
            len(queries.get_reminders(USER_NAME,
                                      description='test_reminder_1')), 5)
        self.assertEqual(
            len(queries.get_reminders(USER_NAME,
                                      description='test_reminder_2')), 5)
        ...
        self.assertEqual(
            len(queries.get_reminders(USER_NAME,
                                      description='test_reminder_1')), 6)
        self.assertEqual(
            len(queries.get_reminders(USER_NAME,
                                      description='test_reminder_2')), 6)
    ...
    def tearDownClass(cls):
        ...
        queries.remove_tasks(USER_NAME, category='test')
